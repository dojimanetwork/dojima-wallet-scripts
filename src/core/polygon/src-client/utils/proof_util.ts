...
import { Converter, promiseResolve, utils } from "../index";
...
export class ProofUtil {
  ...
  // state-sync tx hash = keccak256("dojima-bor-receipt-" + block.number + block.hash)
  static getStateSyncTxHash(block): Buffer {
    return ethUtils.keccak256(
      Buffer.concat([
        ethUtils.toBuffer("dojima-bor-receipt-"), // prefix for bor receipt
