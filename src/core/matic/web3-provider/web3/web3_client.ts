...
import { AbstractProvider, BlockNumber} from "web3-core";
...
export class Web3Client extends BaseWeb3Client {
    ...
    getContract(address: string, abi: AbiItem | AbiItem[]) {
    ...
    getTransactionCount(address: string, blockNumber: BlockNumber) {
    ...
    getBlock(blockHashOrBlockNumber: BlockNumber) {
    ...
    getBlockWithTransaction(blockHashOrBlockNumber: BlockNumber) {
    ...
    signTypedData(signer: any, typedData: any) {
