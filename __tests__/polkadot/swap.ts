...
async function checkPolka() {
    ...
    // const arswapHash = await polkaClient.swap(2,'AR.AR', inboundAddress, '7zzxJgYHgDlaURc3xt3wvLITPp6I8oIpYj_yg_xirb4')
    ...
    const solswapHash = await polkaClient.swap(2,'SOL.SOL', inboundAddress, 'DxehLnrWp8iP5ahoG413BD4azVrkgA8Pob4rXco3mpCS')
